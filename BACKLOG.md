...
- [x] Tap a logged item's photo to expand it (lightbox)
- [x] Delete: confirmation dialog before removing an entry
- [x] Snap tab "Recent" list: show last 3 days of items (more likely to repeat yesterday's meal than the same day's)
